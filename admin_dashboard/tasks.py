...
def send_notification_task(pelanggan_id, tipe_pesan, isi_pesan, url_target=None):
    ...
    """
    # Delay untuk memastikan database sudah stabil sebelum data ditarik
    time.sleep(1)
    ...
    try:
        ...
        print(f"DEBUG TASK: Notifikasi berhasil dibuat dengan ID: {notifikasi.id}")
        ...
        # Debug information
        print(f"--- DEBUG CELERY TASK ---")
        print(f"Channel Group yang dituju: {group_name}")
