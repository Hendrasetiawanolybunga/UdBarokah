...
class Pelanggan(models.Model):
    ...
    nama_bank = models.CharField(max_length=100, null=True, verbose_name="Nama Bank")
    nomor_rekening = models.CharField(max_length=50, null=True, verbose_name="Nomor Rekening")
...
class Transaksi(models.Model):
    ...
    bukti_refund = models.ImageField(
        upload_to='bukti_refund/', 
        verbose_name="Bukti Refund", 
        null=True, 
        blank=True
    )
    
    # NEW FIELD: Catatan pembatalan
    catatan_pembatalan = models.TextField(verbose_name="Catatan Pembatalan", null=True, blank=True)
