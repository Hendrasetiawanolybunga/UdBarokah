...
class PelangganRegistrationForm(forms.ModelForm):
    ...
    class Meta:
        model = Pelanggan
        fields = ['username', 'nama_pelanggan', 'alamat', 'tanggal_lahir', 'no_hp', 'email', 'nama_bank', 'nomor_rekening']
        labels = {
            'username': 'Username',
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Set the new fields as not required
        self.fields['email'].required = False
        self.fields['nama_bank'].required = False
        self.fields['nomor_rekening'].required = False
...
class PelangganEditForm(forms.ModelForm):
    class Meta:
        model = Pelanggan
        fields = ['nama_pelanggan', 'alamat', 'tanggal_lahir', 'no_hp', 'email', 'nama_bank', 'nomor_rekening']
        labels = {
            'nama_pelanggan': 'Nama Lengkap',
            'alamat': 'Alamat',
            'tanggal_lahir': 'Tanggal Lahir',
